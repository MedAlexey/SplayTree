...
public class tests {
    ...
    public void subSetSubSet(){
        ...
        SubSet subSet = (SubSet) tree.subSet(3,10);
        SubSet subSetSubSet = (SubSet) subSet.subSet(5,8);
    ...
    public void subSetIterator(){
        ...
        SubSet subSet = (SubSet) tree.subSet(1,11);
    ...
    public void headSetHeadSet(){
        ...
        HeadSet headSet = (HeadSet) tree.headSet(15);

        HeadSet headSetHeadSet = (HeadSet) headSet.headSet(11);
        ...
        try{
            headSetHeadSet = (HeadSet) headSet.headSet(17);
        }catch(IndexOutOfBoundsException e){
    ...
    public void headSetSubSet(){
        ...
        HeadSet headSet = (HeadSet) tree.headSet(13);
        SubSet subSet = (SubSet) headSet.subSet(4,11);
    ...
    public void headSetIterator(){
        ...
        HeadSet headSet = (HeadSet) tree.headSet(12);
    ...
    public void tailSetTailSet(){
        ...
        TailSet tailSet = (TailSet) tree.tailSet(7);

        TailSet tailSetTailSet = (TailSet) tailSet.tailSet(11);
        ...
        try{
            tailSetTailSet = (TailSet) tailSet.tailSet(3);
        }catch (IndexOutOfBoundsException e){
    ...
    public void tailSetSubSet(){
        ...
        TailSet tailSet = (TailSet) tree.tailSet(9);
        SubSet subSet = (SubSet) tailSet.subSet(9, 13);
        ...
        try{
            subSet = (SubSet) tailSet.subSet(4, 11);
        }catch (IndexOutOfBoundsException e){
    ...
    public void tailSetIterator(){
        ...
        TailSet tailSet = (TailSet) tree.tailSet(11);
